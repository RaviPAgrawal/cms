...
/**
 * Created by raviagrawal on 14/04/17.
 */
public class CmsAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    protected CmsAuthenticationSuccessHandler() {
        super();
    }
    ...
    protected void handle(final HttpServletRequest request, final HttpServletResponse response, final Authentication authentication) throws IOException {
        final String targetUrl = AuthenticationUtility.determineTargetUrl(authentication);
